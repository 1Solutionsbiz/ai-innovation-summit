...
const agendaData: AgendaItem[] = [
  ...
  },
  {
    ...
    description: "This session examines the cybersecurity implications of widespread Generative AI adoption. Panelists will address critical security concerns, risks associated with AI-generated code and data, and best practices to ensure secure and responsible deployment of AI across enterprise IT infrastructures. Moderator: • Preetam Hazarika, Partner, PwC India Panelists: • Sudeep Dey, CIO & CISO, Aster DM Healthcare, India • Vikas Singh Yadav, CISO, Flipkart • Yogesh Kumar, CISO, Fanuc India • Jason Joseph, CISO, mPokket Financial Services Pvt Ltd",
    color: "blue",
  },
  {
    time: "03:00 – 03:45 PM",
