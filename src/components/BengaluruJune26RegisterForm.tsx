            ...
            <div className="space-y-3">
              ...
              <label className="flex cursor-pointer items-start gap-3 text-sm text-slate-200">
                <input
                  ...
                  name="parallelTrack"
                  value="AI Security"
                  checked={formData.parallelTrack === "AI Security"}
                  onChange={handleChange}
                  className="mt-1"
                />
              ...
              <label className="flex cursor-pointer items-start gap-3 text-sm text-slate-200">
                <input
                  type="radio"
                  name="parallelTrack"
                  value="Autonomous Industry Manufacturing"
                  checked={formData.parallelTrack === "Autonomous Industry Manufacturing"}
                  onChange={handleChange}
                  className="mt-1"
                />
              ...
              <label className="flex cursor-pointer items-start gap-3 text-sm text-slate-200">
                <input
                  type="radio"
                  name="parallelTrack"
                  value="Enterprise AI in Action Agents"
                  checked={formData.parallelTrack === "Enterprise AI in Action Agents"}
                  onChange={handleChange}
                  className="mt-1"
                />
                <span>Track C: Enterprise AI in Action Agents</span>
              </label>
            </div>
