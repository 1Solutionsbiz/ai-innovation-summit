...
const Objective: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-black text-white px-4 sm:px-6 md:px-8 lg:px-12 py-12 space-y-12"
    >
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gradient text-center animate-fadeup font-orbitron leading-[1.6]">
        Navigating the Confluence: Cloud and AI in the Era of Digital Transformation and Intelligent Workspaces
      </h1>

      <p className="max-w-4xl mx-auto text-base sm:text-lg text-white text-center animate-fadeup">
      ...
      <div className="max-w-5xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#c084fc] text-center mb-8 animate-fadeup font-orbitron">
          Objectives
        </h2>
        ...
        <div className="space-y-6 sm:space-y-8">
          {objectives.map((obj, index) => (
            <div key={index} className="animate-fadeup">
              <h3 className="text-lg sm:text-xl font-semibold mb-1 font-orbitron text-gradient">
                {obj.title}
              </h3>
