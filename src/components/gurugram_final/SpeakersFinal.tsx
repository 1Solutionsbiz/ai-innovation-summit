...
const FeaturedSpeakers = () => {
  ...
  const upDelay = (order: number, total: number) =>
    `${(revealDirection === "up" ? total - 1 - order : order) * 130}ms`;
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ animationDelay: upDelay(1, 4) }}
                >
                  Voices Leading
                </span>
                <span
            ...
            <div
              className={`min-w-0 partners-reveal-up ${sectionVisible ? "is-visible" : ""}`}
              style={{ animationDelay: upDelay(0, 1) }}
            >
