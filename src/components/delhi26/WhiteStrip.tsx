    ...
    <section className="bg-background  py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto text-center">
          <RevealHeading className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-[#64E0E4] via-[#BF1C88] via-[#5343FF] to-[#2200e8] bg-clip-text text-transparent mb-6">
