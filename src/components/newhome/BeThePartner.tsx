  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-white via-gray-50 to-slate-100 text-white overflow-hidden">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-5xl lh80px font-bold text-center mb-6 text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 bg-clip-text text-transparent">
          Be the Partner Driving Tech Innovation
        </h2>


        <p className="text-center text-slate-600 max-w-3xl mx-auto mb-16 text-xl">
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`mt-2 text-sm leading-relaxed max-w-md becolsec ${
