...
const AgendaNew = () => {
  ...
  const agendaData = [
    ...
    //   description: "<ul><li>Enterprise AI success depends on economics, not just innovation. </li><li> 80%+ of AI initiatives stall due to GPU costs, infrastructure complexity, integration challenges, unclear ROI, and vendor lock-in. </li><li>Poorly architected AI workloads can raise cloud costs by 20-40%. </li><li> This panel explores AI FinOps, infrastructure optimization, model lifecycle management, and scaling AI sustainably.</li></ul> Moderator: Rajat Gupta, Managing Director, BCG \n<b>Speakers : </b>\nAmit Atri, Sr. VP & Global Chief Information Officer, Tata Consumer Products \n Dhivya Kumar Bansal, CDTO, Diageo India\n Amrish Kumar Jain, CIO & CISO, Tally Solutions \nSudeep Dey, CIO & CISO, Aster DM Healthcare ",
    // },
    // {
    //   time: "11:00 – 11:10 AM  ",
    ...
    // {
    //   time: "11:10 – 11:55 AM",
    //   title: "Session 2: Panel Discussion: AI x The Future of Work",
    ...
    //   description: "<strong>Track A: BFSI / FinTech</strong> <br><br> <p>Autonomous Financial Systems</p> <br> <ul><li>Financial services are one of the most AI-intensive sectors, powering use cases from fraud detection to credit risk modelling.</li><li>While AI improves fraud detection by 20-40%, regulatory scrutiny and legacy system integration remain key challenges.</li><li>This track explores AI in regulated environments, small language models, risk and compliance automation, and AI-enabled core banking modernization.</li><li>Focus on building financial AI systems that balance innovation with governance and auditability.</li></ul> <br><b>Moderator:</b> <ul><li>Akbar AliShaikh, Partner - Autonomous Finance, Deloitte </li></ul> <br><b>Speakers :</b> <ul><li>Krishnendu Majumdar, CPTO, Yubi Group</li><li>Nishant Chandra, SVP Engineering, Angel One</li><li>Jyothi Kodenkiri, VP- Cloud Engineering, Deutsche Bank</li><li>Anil Yadav, VP Engineering, HDFC Securities</li></ul>                                                                         \n <strong>Track B: Customer Experience (45 Minutes)</strong> <br><br> <p>Autonomous Customer Platforms</p><br><ul><li>AI-powered agents are transforming customer experience by handling interactions, generating content, and predicting intent in real time.</li><li>AI-driven contact centers can reduce operational costs by 25-30% while improving speed and personalization.</li><li>Scaling AI in CX requires solving data fragmentation, omni-channel orchestration, bias, and ROI measurement.</li><li>This track focuses on building scalable, secure, and measurable AI-driven customer platforms.</li></ul><br><b>Moderator:</b> <ul><li>Pradeep Shinde, Partner, Deloitte </li></ul><br> <b>Speakers :</b> <br><ul><li>Ashley D'Souza, Chief Digital Officer, Hindustan Coca-Cola Beverages </li><li>Kumar S, Chief Technology Officer, Head of AI Strategy and Business, Newgen Digital</li><li>Umesh Bude, CTO, Pocket FM</li><li>Rohan Pagey, Regional Vice President Sales, Salesforce</li></ul>  <br><b>Keynote Address:</b> <ul><li>Grow customer relationships with Agentic Marketing (15 Minutes) </li></ul><br> <b>Speaker:</b> <ul><li>Abhishek Chandra, Senior Specialist SE, Salesforce</li></ul><br><b>Keynote Address:</b> <ul><li> Agentforce Service: Powering Connected Customer Experiences (15 Minutes) </li></ul><br><b>Speaker: </b> <ul><li>Ramneek Narula, Senior Product Manager, Salesforce </li></ul><br>                                                                                              \n <strong>Track C: Manufacturing / Digital Twins </strong> <br><br> <p>Autonomous Industrial Systems</p><br><ul><li>Manufacturing is adopting AI-driven digital twins and predictive systems to optimize operations.</li><li>AI-powered predictive maintenance can reduce downtime by up to 30% and maintenance costs by 10-20%.</li><li>Industrial AI requires edge computing, secure IoT infrastructure, and cross-system interoperability.</li><li>This track explores how AI is embedded into industrial systems and supply chains to enable autonomous production environments.</li></ul><br>   <b>Moderator:</b> <br><ul><li>S Sathish, Partner and National Sector Leader- Industrial Manufacturing, KPMG India </li></ul> <br>    <b>Speakers :</b> <br><ul><li>Chandan Vijay, Global Chief Data Officer, ABB Energy Industries </li><li>Akilur Rahman, CTO, Hitachi Energy India </li><li>Shashi Mohan Singh, CDO, Reliance Consumer Products </li></ul>",
    // },
    // {
    //   time: "03:30 – 03:45 PM",
